...
public class RouteMyViewModel extends AdapterViewModel<MutableLiveData<MyAndApplyBean>> {
    ...
    public static RouteMyViewModel getInstance() {
        if (instance == null) {
            synchronized (RouteMyViewModel.class) {
                if (instance == null) {
                    instance = new RouteMyViewModel();
                }
            }
        }
        return instance;
